...
CREATE INDEX `authors_names` ON `authors` (`last_name`,`first_name`);--> statement-breakpoint
CREATE INDEX `authors_email` ON `authors` (`email`);--> statement-breakpoint
...
CREATE INDEX `papers_year` ON `papers` (`paper_year`);--> statement-breakpoint
CREATE INDEX `papers_month` ON `papers` (`paper_month`);--> statement-breakpoint
